...
var helpCommands = []helpCommandEntry{
	...
	},
	{
		...
		Usage:       []string{"onlava harness [--app-root <path>] [--json] [--write] [--with-validation[=<profile>]]", "onlava harness self [--repo-root <path>] [--summary|--json|--json=summary|--json=full] [--write] [--quick|--race|--release]", "onlava harness ui --json [--app-root <path>] [--dashboard-url <url>] [--headed] [--write]"},
