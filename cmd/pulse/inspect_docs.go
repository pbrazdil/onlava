...
const (
	docsIndexSchema   = "pulse.docs.index.v1"
	inspectDocsSchema = "pulse.inspect.docs.v1"
)
...
func validateDocsKnowledge(repoRoot string) ([]checkDiagnostic, map[string]any) {
	...
	if err != nil {
		return []checkDiagnostic{{
			...
			Message:         err.Error(),
			SuggestedAction: "Fix docs/knowledge.json so it conforms to pulse.docs.index.v1.",
		}}, summary
	}
