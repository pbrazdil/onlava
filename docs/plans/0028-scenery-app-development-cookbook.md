...
scenery needs a practical cookbook for building and evolving apps. `docs/local-contract.md` defines contracts, and `docs/index.md` routes readers through the knowledge base, but agents need recipe-style "how to build X" guidance with commands, examples, and common failure modes.
...
agent opens docs/app-development-cookbook.md
        |
        v
agent implements an app feature with the right scenery APIs and validation commands
```

## Progress

* [x] 2026-05-09: Create this ExecPlan as `docs/plans/0028-scenery-app-development-cookbook.md`.
...
* scenery has many current app-facing surfaces: typed APIs, raw APIs, auth, middleware, Pub/Sub, cron, pgxpool tracing, generated TypeScript clients, local proxy/frontend config, inspect commands, logs, traces, metrics, and harnesses.
...
The cookbook should explain how to build with public scenery surfaces, not how to modify internals.
