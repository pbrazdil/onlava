...
- `cmd/scenery/dev_frontends.go` starts managed frontends and injects `API_BASE_URL`, `SCENERY_API_BASE_URL`, `VITE_API_BASE_URL`, `ELECTRIC_URL`, `SCENERY_ELECTRIC_URL`, and `VITE_ELECTRIC_URL`.
