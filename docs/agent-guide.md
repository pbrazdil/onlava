...
Use `onlava inspect docs --json` when the binary is available. It reports indexed docs, missing docs, stale docs, plan paths, discovered `AGENTS.md` scopes, and Child Agent Index drift.
